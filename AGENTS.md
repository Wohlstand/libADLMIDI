...
compatible with the GPLv3+ or LGPLv2.1+ license, or may introduce conflicting
license terms if they include code from other projects.
...
author and that you are contributing your changes under the GPLv3+ or LGPLv2.1+
licenses.
